                ...
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                    <div class="p-6 text-gray-900">
                        ...
                        <div class="mt-4">
                            ...
                            <x-text-input id="nom_dep" class="block mt-1 w-full" type="text" name="nom_dep" :value="old('nom_dep')" required autofocus autocomplete="nom_dep" />
                        ...
                        <div class="mt-4">
                            ...
                            <x-text-input id="code_dep" class="block mt-1 w-full" type="text" name="code_dep" :value="old('code_dep')" required autocomplete="code_dep" />
